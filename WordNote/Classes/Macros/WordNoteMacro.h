 ...
 *   time:2015-4-15                                                                                       *
 *   author:Yoni_yang                                                                                  *
 *   description:device size 、font scale、viewSizeScale、navBar  height、tabBar  height                   *
 *                                                                                                       *
 *********************************************************************************************************/
 ...
 *   time:2015-4-15                                                                                       *
 *   author:Yoni_yang                                                                                 *
 *   description:  others  common  macro                                                                 *
 *                                                                                                       *
 *********************************************************************************************************/
